...
Created by Odie at appledog77.github.io and ladybug-lane.neocities.org (sleepysloth.turtle025@silomails.com)
...
Twinkling Galaxy Hues Balloon, mocking text code, capitalize text code, GhostIsOpen & GhostIsInstalled code, and minigames by Zichqec! https://ukagaka.zichqec.com/
...
The shell graphics can be used for anything (no credit needed, but don't make freeshells out of it), especially non-ukagaka stuff like games (I'd love to see that)! :D
...
Ver 2.0 - Ported to Simplicity Template! Added more aitalk and boot up dialogue, more Commu stuff (including changing it to use the GhostIsOpen & GhostIsInstalled function by Zichqec), Capitalization to RPS dialogue, nighttime boot up and shutdown dialogue, version number to menu, and quote to readme. Standardized the Terms of Use and fixed a/an in the wallpapers and screensavers item dialogue. Sadly, NameTeach has been removed for now, but I plan to add it back to a Config Menu in the next update. (Mon, Apr 27, 2026)
